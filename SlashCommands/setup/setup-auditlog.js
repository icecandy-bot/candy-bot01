...
module.exports = {
  name: 'setup-auditlog', //developer by tn_hazem
  ...
  run: async (client, interaction, args) => {
    let row = new Discord.MessageActionRow().addComponents(
      ...
      new Discord.MessageButton()
        ...
        .setCustomId(`mem`)
        .setStyle(`SECONDARY`),
      new Discord.MessageButton()//developer by tn_hazem
    ...
    let row1 = new Discord.MessageActionRow().addComponents(
      ...
      new Discord.MessageButton()
        ...
        .setStyle(`SECONDARY`),
      new Discord.MessageButton()
        .setLabel(`Timeout Log`)//developer by tn_hazem
        .setCustomId(`Timeout`)
        .setStyle(`SECONDARY`),
      new Discord.MessageButton()
        .setLabel(`thread Log`)
        ...
        .setStyle(`SECONDARY`),
      new Discord.MessageButton()
        .setLabel(`Roles Log`)//developer by tn_hazem
        .setCustomId(`role`)
        .setStyle(`SECONDARY`)
    );
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setTitle(`Setup Your Logs!`)//developer by tn_hazem
